...
| Property | Type | Description |
|---|---|---|
| `Action` | `TradeAction` | Gets or sets the command action. |
...
| `VisibleTimeframes` | `TimeFrameOptions` | Gets or sets the set of timeframes on which this indicator is displayed. Default is . |
